    ...
    return (
        <footer className="max-container">
            <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col ">
                ...
                <div className="flex flex-1 justify-between lg:g-10 g-12 flex-wrap">
                        ...
                        <div key={section.title}>
                            ...
                            <ul>
                                {section.links.map((link) => (
                                    <li className="mt-3 text-white-400 font-montserrat text-base leading-normal hover:text-slate-gray cursor-pointer mr-4"
                                        key={link.name}>
                                        <a href="/">{link.name}</a>
                                    </li>
                                ))}
            ...
            <div className="flex justify-between text-white-400 mt-24 max-sm:flex-col max-sm:items-center">
                <div className="flex flex-1 justify-start items-center gap-2 font-montserrat cursor-pointer">
                    <img className="rounded-full m-0 hover:text-slate-gray"
                        src={copyrightSign} alt="copy rigt" width={20} height={20}
                    />
